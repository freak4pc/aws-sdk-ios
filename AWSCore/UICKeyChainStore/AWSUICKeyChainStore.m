...
@implementation AWSUICKeyChainStore
...
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:AWSUICKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = AWSUICKeyChainStoreItemClassGenericPassword;
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:AWSUICKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(AWSUICKeyChainStoreProtocolType)protocolType authenticationType:(AWSUICKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = AWSUICKeyChainStoreItemClassInternetPassword;
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    AWSUICKeyChainStore *keychain = [AWSUICKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(AWSUICKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == AWSUICKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == AWSUICKeyChainStoreItemClassInternetPassword) {
...
{
    switch (_itemClass) {
        case AWSUICKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case AWSUICKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case AWSUICKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case AWSUICKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case AWSUICKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case AWSUICKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case AWSUICKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case AWSUICKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case AWSUICKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case AWSUICKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case AWSUICKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case AWSUICKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case AWSUICKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case AWSUICKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case AWSUICKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case AWSUICKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case AWSUICKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case AWSUICKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case AWSUICKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case AWSUICKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case AWSUICKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case AWSUICKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case AWSUICKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case AWSUICKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case AWSUICKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case AWSUICKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case AWSUICKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case AWSUICKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case AWSUICKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case AWSUICKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case AWSUICKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case AWSUICKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case AWSUICKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case AWSUICKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case AWSUICKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case AWSUICKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case AWSUICKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case AWSUICKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case AWSUICKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case AWSUICKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case AWSUICKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case AWSUICKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case AWSUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case AWSUICKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case AWSUICKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case AWSUICKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:AWSUICKeyChainStoreErrorDomain code:AWSUICKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:AWSUICKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:AWSUICKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:AWSUICKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
